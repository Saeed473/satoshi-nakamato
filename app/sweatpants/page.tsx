...
const Sweatpants = () => {
  ...
  // Normalize and filter sweatpants only
  const sweatpantsProducts: Product[] = allProducts
    .filter((product: any) => product.category?.toLowerCase() === "sweatspants")
    .map((p: any) => ({
      ...p,
  ...
  const sortedProducts = useMemo(() => {
    const products = [...sweatpantsProducts];
    ...
    return (
      <div className="w-full bg-white">
        ...
        <div className="px-10 py-20 text-center">
          ...
          <p className="mt-4 text-gray-600">Loading sweatpants...</p>
        </div>
      </div>
    );
  }
        ...
        {sortedProducts.length > 0 ? (
          ...
          <div className="col-span-full text-center py-20">
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-2">
              No Sweatpants Available
            </h3>
            <p className="text-gray-500">
              Check back soon for new sweatpants in our collection.
            </p>
          </div>
        )}
      </div>
