...
const Hats = () => {
  ...
  const hatProducts: Product[] = allProducts
    .filter((product: any) => product.category?.toLowerCase() === "hats")
    .map((p: any) => ({
      ...p,
    ...
    return (
      <div className="w-full bg-white">
        ...
        <div className="px-10 py-20 text-center">
          ...
          <p className="mt-4 text-gray-600">Loading hats...</p>
        </div>
      </div>
    );
  }
        ...
        {sortedProducts.length > 0 ? (
          ...
          <div className="col-span-full text-center py-20">
            ...
            <p className="text-gray-500">
              Check back soon for new hats in our collection.
            </p>
          </div>
        )}
      </div>
