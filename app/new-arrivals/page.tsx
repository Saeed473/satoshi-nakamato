...
const NewArrivalsPage = () => {
  ...
  // Normalize products to camelCase for frontend
  ...
  // Filter new arrivals
  const newArrivals = normalizedProducts.filter(
  ...
  return (
    <div className="w-full bg-white">
      ...
      <div className={`px-10 mb-16 ${getGridClass()}`}>
        {sortedProducts.length > 0 ? (
          ...
          <div className="col-span-full text-center py-20">
            ...
            <p className="text-gray-500">
              Check back soon for new products in our collection.
            </p>
          </div>
        )}
      </div>
